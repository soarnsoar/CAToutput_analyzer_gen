...
void MG_histo_compare(){

  TFile *file;
  file = TFile::Open("../ISR_ntuple_gen_muon_v3/histograms/MG.root");
  ...
  TH1D *hdiptm = (TH1D*)file->Get("diptfsr");
  TH1D *hdiptm4060= (TH1D*)file->Get("diptfsr4060");
  TH1D *hdiptm80100= (TH1D*)file->Get("diptfsr80100");
  TH1D *hdiptm100200= (TH1D*)file->Get("diptfsr100200");
  TH1D *hdiptm200350= (TH1D*)file->Get("diptfsr200350");

  file = TFile::Open("../ISR_ntuple_gen_electron_v3/histograms/MG.root");

  TH1D *hdipte = (TH1D*)file->Get("diptfsr");
  TH1D *hdipte4060= (TH1D*)file->Get("diptfsr4060");
  TH1D *hdipte80100= (TH1D*)file->Get("diptfsr80100");
  TH1D *hdipte100200= (TH1D*)file->Get("diptfsr100200");
  TH1D *hdipte200350= (TH1D*)file->Get("diptfsr200350");
  hdiptm->Sumw2();
  hdiptm4060->Sumw2();
  hdiptm80100->Sumw2();
  hdiptm100200->Sumw2();
  ...
  hdipte->SetTitle("P_{T}(ll + FSR) #mu#mu vs ee");
  hdiptm->SetTitle("P_{T}(ll + FSR) #mu#mu vs ee");
  ...
  cdipt->SaveAs("plot_files/MGdipt_emucompare.png"); 
   //////////////////////////////////////////////////
  ...
  hdipte4060->SetTitle("P_{T}(ll + FSR) #mu#mu vs ee, 40 < M[GeV] < 60");
  hdiptm4060->SetTitle("P_{T}(ll + FSR) #mu#mu vs ee, 40 < M[GeV] < 60");
  ...
  cdipt4060->SaveAs("plot_files/MGdipt_emucompare4060.png"); 
  //////////////////////////////////////////////////
  ...
  hdipte80100->SetTitle("P_{T}(ll + FSR) #mu#mu vs ee, 80 < M[GeV] < 100");
  hdiptm80100->SetTitle("P_{T}(ll + FSR) #mu#mu vs ee, 80 < M[GeV] < 100");
  ...
  cdipt80100->SaveAs("plot_files/MGdipt_emucompare80100.png"); 
  //////////////////////////////////////////////////
  ...
  hdipte100200->SetTitle("P_{T}(ll + FSR) #mu#mu vs ee, 100 < M[GeV] < 200"); hdiptm100200->SetTitle("P_{T}(ll + FSR) #mu#mu vs ee, 100 < M[GeV] < 200");
  ...
  cdipt100200->SaveAs("plot_files/MGdipt_emucompare100200.png"); 
  //////////////////////////////////////////////////
  ...
  hdipte200350->SetTitle("P_{T}(ll + FSR) #mu#mu vs ee, 200 < M[GeV] < 350");
  hdiptm200350->SetTitle("P_{T}(ll + FSR) #mu#mu vs ee, 200 < M[GeV] < 350");
  ...
  cdipt200350->SaveAs("plot_files/MGdipt_emucompare200350.png"); 
  //////////////////////////////////////////////////
