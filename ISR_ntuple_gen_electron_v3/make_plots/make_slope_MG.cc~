void make_slope_MG(){
  ...
  */
  ...
  TGraphErrors *PTQQf = new TGraphErrors(4,x,y,ex,eey);
  cout<<"Exclude FSR, MG"<<endl;
  PTQQ->Print();
  TF1 *ff = new TF1("ff", "[1] * log(x) + [0]");
  //PTQQf->Fit(ff);
  PTQQ->SetTitle("Gen-Level No FSR vs FSR, Madgraph 13TeV");
  PTQQ->GetXaxis()->SetTitle("<M(#mu#mu)>^{2} [ GeV^{2} ]");
  PTQQ->GetYaxis()->SetTitle("<P_{T}(#mu#mu)> [ GeV ]");
  ...
  pt4060 = ((TH1D*)MGfile->Get("diptfsr4060"))->GetMean();
  pt80100 = ((TH1D*)MGfile->Get("diptfsr80100"))->GetMean();
  pt100200 = ((TH1D*)MGfile->Get("diptfsr100200"))->GetMean();
  pt200350 = ((TH1D*)MGfile->Get("diptfsr200350"))->GetMean();

  spt4060 = ((TH1D*)MGfile->Get("diptfsr4060"))->GetRMS();
  spt80100 = ((TH1D*)MGfile->Get("diptfsr80100"))->GetRMS();
  spt100200 = ((TH1D*)MGfile->Get("diptfsr100200"))->GetRMS();
  spt200350 = ((TH1D*)MGfile->Get("diptfsr200350"))->GetRMS();

  n4060 = ((TH1D*)MGfile->Get("diptfsr4060"))->GetEntries();
  n80100 = ((TH1D*)MGfile->Get("diptfsr80100"))->GetEntries();
  n100200 = ((TH1D*)MGfile->Get("diptfsr100200"))->GetEntries();
  n200350 = ((TH1D*)MGfile->Get("diptfsr200350"))->GetEntries();
  /*
  dpt4060 = spt4060/sqrt(n4060);
  dpt80100 = spt80100/sqrt(n80100);
  dpt100200 = spt100200/sqrt(n100200);
  ...
  */
  ...
  dpt4060 = ((TH1D*)MGfile->Get("diptfsr4060"))->GetMeanError();
  dpt80100 = ((TH1D*)MGfile->Get("diptfsr80100"))->GetMeanError();
  dpt100200 = ((TH1D*)MGfile->Get("diptfsr100200"))->GetMeanError();
  dpt200350 = ((TH1D*)MGfile->Get("diptfsr200350"))->GetMeanError();


  
  m4060 = ((TH1D*)MGfile->Get("dimassfsr4060"))->GetMean();
  m80100 = ((TH1D*)MGfile->Get("dimassfsr80100"))->GetMean(); 
  m100200 = ((TH1D*)MGfile->Get("dimassfsr100200"))->GetMean();
  m200350 = ((TH1D*)MGfile->Get("dimassfsr200350"))->GetMean();
  
  sm4060 = ((TH1D*)MGfile->Get("dimassfsr4060"))->GetRMS();
  sm80100 = ((TH1D*)MGfile->Get("dimassfsr80100"))->GetRMS(); 
  sm100200 = ((TH1D*)MGfile->Get("dimassfsr100200"))->GetRMS();
  sm200350 = ((TH1D*)MGfile->Get("dimassfsr200350"))->GetRMS();
  ...
  TGraphErrors *PTQQf_fsr = new TGraphErrors(4,x,y,ex,eey);

  TF1 *ff_fsr = new TF1("ff_fsr", "[1] * log(x) + [0]");
  cout<<"Include FSR, MG"<<endl;
  PTQQ_fsr->Print();
  //PTQQf_fsr->Fit(ff_fsr);
  PTQQ_fsr->SetTitle("Gen-Level No FSR vs FSR, Madgraph 13TeV");
  PTQQ_fsr->GetXaxis()->SetTitle("<M(#mu#mu)>^{2} [ GeV^{2} ]");
  PTQQ_fsr->GetYaxis()->SetTitle("<P_{T}(#mu#mu)> [ GeV ]");
