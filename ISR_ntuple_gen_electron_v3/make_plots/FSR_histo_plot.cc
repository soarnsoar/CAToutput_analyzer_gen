...
void FSR_histo_plot(){
 ...
 cout<<"200350 mass range"<<endl;
  ...
  hdiptMG->SetTitle("P_{T}(ee + FSR) MG vs NLO");
  hdiptNLO->SetTitle("P_{T}(ee + FSR) MG vs NLO");
  ...
  hdiptMG4060->SetTitle("P_{T}(ee + FSR) MG vs NLO, 40 < M[GeV] < 60");
  hdiptNLO4060->SetTitle("P_{T}(ee + FSR) MG vs NLO, 40 < M[GeV] < 60");
  ...
  hdiptMG80100->SetTitle("P_{T}(ee + FSR) MG vs NLO, 80 < M[GeV] < 100");
  hdiptNLO80100->SetTitle("P_{T}(ee + FSR) MG vs NLO, 80 < M[GeV] < 100");
  ...
  stNLO80100->TPaveStats::SetY1NDC(0.8);
  stNLO80100->TPaveStats::SetY2NDC(0.9);
  ...
  hdiptMG100200->SetTitle("P_{T}(ee + FSR) MG vs NLO, 100 < M[GeV] < 200");   hdiptNLO100200->SetTitle("P_{T}(ee + FSR) MG vs NLO, 100 < M[GeV] < 200");
  ...
  hdiptMG200350->SetTitle("P_{T}(ee + FSR) MG vs NLO, 200 < M[GeV] < 350");
  hdiptNLO200350->SetTitle("P_{T}(ee + FSR) MG vs NLO, 200 < M[GeV] < 350");
