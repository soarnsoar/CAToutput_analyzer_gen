void make_slope_fsr(){
  ...
  */
  ...
  // PTQQ_NLO->Fit(ff_NLO);
  PTQQ_NLO->SetTitle("Gen-Level Muon+FSR aMC@NLO & Madgraph 13TeV");
  PTQQ_NLO->GetXaxis()->SetTitle("<M(#mu#mu)>^{2} [ GeV^{2} ]");
  PTQQ_NLO->GetYaxis()->SetTitle("<P_{T}(#mu#mu)> [ GeV ]");
  ...
  */
  ...
  // PTQQ_MG->Fit(ff_MG);
  PTQQ_MG->SetTitle("Gen-Level Muon+FSR aMC@NLO & Madgraph 13TeV");
  PTQQ_MG->GetXaxis()->SetTitle("<M(#mu#mu)>^{2} [ GeV^{2} ]");
  PTQQ_MG->GetYaxis()->SetTitle("<P_{T}(#mu#mu)> [ GeV ]");
  ...
  leg->Draw();
  c1->SaveAs("plot_files/slope_fsr.png");  
}
