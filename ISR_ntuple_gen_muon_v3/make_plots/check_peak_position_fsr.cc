void check_peak_position_fsr(){
  ...
  */
  ...
  TH1F *mgpeak = new TH1F("Peak Position[GeV], MG, including FSR mom.","Peak Position[GeV], #mu#mu, including FSR mom.",5,0,5 );
  ...
  mgpeak->SetStats(0);
  mgpeak->GetYaxis()->SetTitle("Peak Position [GeV]");
  mgpeak->GetYaxis()->SetRangeUser(3,5);
  //mgpeak->Draw();

  mgpeak->GetXaxis()->SetLabelSize(0.05);
  TH1F *nlopeak = new TH1F("Peak Position[GeV], aMC@NLO, including FSR mom.","Peak Position[GeV], aMC@NLO, including FSR mom.",5,0,5 );
  ...
  nlopeak->GetYaxis()->SetRangeUser(3,5);
  //nlopeak->Draw();
  TCanvas *c1 = new TCanvas();
  TLegend * leg = new TLegend(0.7,0.85,0.15,0.6);
  leg->TLegend::AddEntry(mgpeak, "MG, + FSR mom.");
  leg->TLegend::AddEntry(nlopeak, "aMC@NLO, + FSR mom.");
  ...
  leg->Draw();
  c1->SaveAs("plot_files/peak_position_fsr.png");  
}
