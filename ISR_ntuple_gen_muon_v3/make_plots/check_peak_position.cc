void check_peak_position(){
  ...
  */
  ...
  TH1F *mgpeak = new TH1F("Peak Position[GeV], #mu#mu, MG, w/o FSR mom.","Peak Position[GeV], #mu#mu, w/o FSR mom.",5,0,5 );
  ...
  TH1F *nlopeak = new TH1F("Peak Position[GeV], aMC@NLO, w/o FSR mom.","Peak Position[GeV], aMC@NLO, w/o FSR mom.",5,0,5 );
