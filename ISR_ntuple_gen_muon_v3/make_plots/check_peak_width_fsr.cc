void check_peak_width_fsr(){
  ...
  */
  ...
  TH1F *mgpeak = new TH1F("Peak width[GeV], MG, including FSR mom.","Peak width[GeV], #mu#mu, including FSR mom.",5,0,5 );
  ...
  TH1F *nlopeak = new TH1F("Peak width[GeV], aMC@NLO, including FSR mom.","Peak width[GeV], aMC@NLO, including FSR mom.",5,0,5 );
  ...
  leg->Draw();
  c1->SaveAs("plot_files/peak_width_fsr.png");  
}
